...
public abstract class MediaVideoEncoderBase extends MediaEncoder {
     ...
     * @return
     */
    protected MediaFormat create_encoder_format(final String mime, final int frame_rate, final int bitrate, final int orientation) {
        if (DEBUG)
            Log.v(TAG, String.format("create_encoder_format:(%d,%d),mime=%s,frame_rate=%d,bitrate=%d", mWidth, mHeight, mime, frame_rate, bitrate));
    ...
    protected Surface prepare_surface_encoder(final String mime, final int frame_rate, final int bitrate, final int orientation)
            throws IOException, IllegalArgumentException {

        Log.v(TAG, String.format("prepare_surface_encoder:(%d,%d),mime=%s,frame_rate=%d,bitrate=%d",
                mWidth, mHeight, mime, frame_rate, bitrate));
        ...
        final MediaFormat format = create_encoder_format(mime, frame_rate, bitrate, orientation);
