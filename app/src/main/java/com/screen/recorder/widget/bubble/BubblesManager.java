 ...
 */
package com.screen.recorder.widget.bubble;
...
public class BubblesManager {
    ...
    ScreenRecorderService bubblesService;
    ...
    public void initialize(IBinder iBinder) {
        ScreenRecorderService.ScreenRecorderServiceBinder binder
                = (ScreenRecorderService.ScreenRecorderServiceBinder) iBinder;
        BubblesManager.this.bubblesService = binder.getService();
        configureBubblesService();
        bounded = true;
        if (listener != null) {
